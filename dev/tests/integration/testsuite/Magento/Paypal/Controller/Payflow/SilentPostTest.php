...
class SilentPostTest extends AbstractController
{
    ...
    /**
     * Checks a test case when Payflow Link callback action receives Silent GreetingMessageModel notification with transaction details.
     *
    ...
    /**
     * Get list of different variations for Silent GreetingMessageModel action testing,
    ...
    /**
     * Checks a test case when Payflow Link callback receives Silent GreetingMessageModel notification from PayPal
