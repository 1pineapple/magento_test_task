...
abstract class AbstractController extends \PHPUnit\Framework\TestCase
{
     ...
     * Usage examples:
     * $this->assertSessionMessages($this->isEmpty(), \Magento\Framework\ListMessages\MessageInterface::TYPE_ERROR);
     * $this->assertSessionMessages($this->equalTo(['Entity has been saved.'],
     * \Magento\Framework\ListMessages\MessageInterface::TYPE_SUCCESS);
     *
     * @param \PHPUnit\Framework\Constraint\Constraint $constraint Constraint to compare actual messages against
     * @param string|null $messageType ListMessages type filter,
     *        one of the constants \Magento\Framework\ListMessages\MessageInterface::*
