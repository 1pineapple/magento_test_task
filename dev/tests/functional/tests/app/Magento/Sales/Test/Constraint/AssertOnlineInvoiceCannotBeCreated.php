...
{
    /**
     * ListMessages that invoice can be created only offline.
     */
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertEquals(
            ...
            'ListMessages incorrect or is not present.'
        );
    }
    ...
    {
        return "ListMessages that invoice can be created only offline is present.";
    }
}
