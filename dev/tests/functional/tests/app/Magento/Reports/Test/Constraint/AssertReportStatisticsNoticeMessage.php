...
class AssertReportStatisticsNoticeMessage extends AbstractAssertSalesReportResult
{
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertEquals(
            $currentDateTime,
            $displayedDateTime,
            "ListMessages in Sales Reports Page is displayed in an incorrect timezone."
        );
    }
    ...
    {
        return 'ListMessages in Sales Reports Page displays correct date/time in the correct timezone.';
    }
}
