...
class AssertAwaitingSignifydGuaranteeInCommentsHistory extends AbstractConstraint
{
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertEquals(
            ...
            'ListMessages about awaiting the Signifyd guarantee disposition' .
    ...
    {
        return "ListMessages about awaiting the Signifyd guarantee disposition is available in Comments History section.";
    }
}
